...
export default function CardSelectScene1({ onSceneChange }: SceneProps) {
  ...
  const cards = Array.from({ length: 16 }, (_, index) => {
    ...
    const x =
      colIndex * (cardWidth + cardOverlap) - totalRowWidth / 2 + cardWidth / 2;
    const y = row === 0 ? (isMobile ? -90 : -120) : isMobile ? 10 : 10;
  ...
  const Card = React.memo(
    ({
      ...
      return (
        ...
        >
          <img
            src="https://dmfnb4l6be84v.cloudfront.net/simulator2/card/card_back.webp"
            alt="Card back"
  ...
  return (
    <SceneLayout
      bg="https://dmfnb4l6be84v.cloudfront.net/simulator2/%EB%B0%95%EC%A0%95%EB%AF%BC_3.webp"
      effect="trueBlend"
      nextBgList={[
      ...
      <div className="relative flex h-screen flex-col justify-end overflow-hidden bg-cover bg-center">
        ...
        >
          <DialogueBox
            ...
            onTouchSceneChange={
              !showCards ? () => onSceneChange("worry") : undefined
            }
