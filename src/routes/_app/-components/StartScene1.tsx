      ...
      >
        <div className="relative w-[90%] max-w-md">
          <input
            ...
            className="px-4 py-3 rounded-full border-2 border-soft-blue focus:outline-none focus:ring-2 focus:ring-amber-500 w-full shadow-lg text-center bg-white/90 backdrop-blur-sm text-gray-800"
            maxLength={12}
          />
        ...
        <motion.button
          ...
          className="bg-soft-blue text-white px-8 py-3 rounded-full shadow-lg hover:bg-amber-600 transition-all duration-300 font-bold tracking-wider"
